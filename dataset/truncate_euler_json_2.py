...
def filter_coco_annotations(input_json_path, output_json_path, angle_threshold=8, filename_pattern="lpff"):
    """
    ...
    exist_path = '/data/xiaoshuai/facial_landmark_181/train_0326/npys'
    ...
    for ann in annotations:
        ...
        file_path = os.path.join(exist_path, filename.split('.')[0] + ".npy")
        if os.path.isfile(file_path):
            print(file_path)
            continue
...
if __name__ == "__main__":
    ...
    output_file = "/data/xiaoshuai/facial_lanmark/train_0126/annotations/train_filtered_annotations_refine_2.json"
    
    filter_coco_annotations(input_file, output_file, angle_threshold=8)