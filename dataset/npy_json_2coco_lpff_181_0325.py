...
def get_euler_json_path(img_name, json_base_paths):
    ...
    EULER_PATH_MAP = json_base_paths.get("normal", {
        ...
        "lpff": "/data/xiaoshuai/facial_lanmark/datasets/lpff/kuaishou_euler_annotions",
        # "auglpff": "/data/xiaoshuai/facial_lanmark/datasets/lpff/kuaishou_euler_annotions"
        "eyeaug": "/data/xiaoshuai/facial_lanmark/datasets/lpff/kuaishou_euler_annotions",
        # "lpff": "/data/xiaoshuai/facial_lanmark/train_0325/lpff_Kuaishou-ldms",
        "EyeData" : "/data/xiaoshuai/facial_lanmark/train_0325/eye_data_Kuaishou-ldms",
        "MouthData" : "/data/xiaoshuai/facial_lanmark/train_0325/eye_data_Kuaishou-ldms",
        "SpecialData": "/data/xiaoshuai/facial_lanmark/train_0325/SpecialData_Kuaishou-ldms"
    })
    ...
    elif "eyeaug_lpff" in img_name:
        prefix = img_name.split('_')[0]
        if prefix in EULER_PATH_MAP:
            euler_base_path = EULER_PATH_MAP[prefix]
            euler_path = os.path.join(euler_base_path, img_name.split('_')[2] + '.json')
            return euler_path, "normal"
    elif "lpff" in img_name:
        prefix = img_name.split('_')[0]
        if prefix in EULER_PATH_MAP:
            euler_base_path = EULER_PATH_MAP[prefix]
            euler_path = os.path.join(euler_base_path, img_name.split('_')[1] + '.json')
            return euler_path, "normal"
    # elif "lpff" in img_name:
    #     prefix = img_name.split('_')[0]
    #     if prefix in EULER_PATH_MAP:
    #         euler_base_path = EULER_PATH_MAP[prefix]
    #         euler_path = os.path.join(euler_base_path, img_name + '.json')
    #         return euler_path, "normal"
    elif "Data" in img_name:
...
def convert_to_coco_format(image_dir, npy_dir, output_json_path, json_base_paths=None):
    ...
    for img_path in tqdm(image_paths, desc="Converting annotations"):
        ...
        try:
            ...
            # bboxes_square = infodict["squarebbox"]
        ...
        if len(bboxes) > 0:
            ...
            # bbox_s = bboxes_square[0]
            # x1_s, y1_s, w_s, h_s = bbox_s
            ...
            # 尝试获取欧拉角数据
            # print(f"Processing {img_name} for Euler angles...")
            ...
            if euler_json_path and os.path.exists(euler_json_path):
                ...
                print(f"Error parsing euler json {euler_json_path}: file not found")
            ...
            annotation = {
                ...
                # "square": [float(x1_s), float(y1_s), float(w_s), float(h_s)],
                "area": float(area),
                "iscrowd": 0,
                "keypoints": keypoints,
                "num_keypoints": 181,
...
if __name__ == "__main__":
    ...
    # image_dir = "/data/xiaoshuai/facial_landmark_181/train_0326/images/" 
    # npy_dir = "/data/xiaoshuai/facial_landmark_181/train_0326/npys/"
    # output_json_path = "/data/xiaoshuai/facial_landmark_181/train_0326/annotations/train_angles_annotations_181.json"
    
    # image_dir = "/data/xiaoshuai/facial_landmark_181/train_0326/val_images/" 
    # npy_dir = "/data/xiaoshuai/facial_landmark_181/train_0326/val_npys/"
    # output_json_path = "/data/xiaoshuai/facial_landmark_181/train_0326/annotations/val_angles_annotations_181.json"
    
    image_dir = "/data/xiaoshuai/facial_landmark_181/train_0331/images/" 
    npy_dir = "/data/xiaoshuai/facial_landmark_181/train_0331/npys/"
    output_json_path = "/data/xiaoshuai/facial_landmark_181/train_0331/annotations/train_angles_annotations_181.json"
