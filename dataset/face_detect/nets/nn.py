...
class FaceDetector:
    def __init__(self, onnx_file=None, session=None):
        ...
        if self.session is None:
            ...
            self.session = InferenceSession(onnx_file, providers=['CPUExecutionProvider'])
            # self.session = InferenceSession(onnx_file)
    ...
    def forward(self, image, thresh):
        ...
        for idx, stride in enumerate(self._feat_stride_fpn):
            ...
            bboxes = distance2bbox(anchor_centers, boxes, self.input_shape)
