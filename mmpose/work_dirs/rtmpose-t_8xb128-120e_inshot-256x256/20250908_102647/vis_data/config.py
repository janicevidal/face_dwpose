...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        interval=1,
        out_dir=
        '/home/zhangxiaoshuai/Project/face_dwpose/mmpose/work_dirs/rtmpose-t_8xb128-120e_inshot-256x256/',
        show=False,
...
launcher = 'none'
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/rtmpose-t_8xb128-120e_inshot-256x256/epoch_299.pth'
log_level = 'INFO'
log_processor = dict(
    _scope_='mmpose',
    by_epoch=True,
...
work_dir = './work_dirs/rtmpose-t_8xb128-120e_inshot-256x256'
