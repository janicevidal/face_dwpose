...
class TopdownPosePrealignEstimatorMultitask(BasePoseEstimator):
    ...
    def add_pred_to_datasample(self, batch_pred_instances: InstanceList,
        ...
        for pred_instances, pred_fields, data_sample in zip_longest(
            ...
            pred_instances.euler_yaws = np.expand_dims(pred_instances.euler_yaws, axis=0)
            pred_instances.euler_pitchs = np.expand_dims(pred_instances.euler_pitchs, axis=0)
