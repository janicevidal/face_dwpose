dataset_info = dict(
    ...
    keypoint_info={
        ...
        # 添加203-204点 (左眼眼球轮廓)
        203: dict(name='kpt-203', id=203, color=[255, 0, 0], type='', swap='kpt-206'),
        204: dict(name='kpt-204', id=204, color=[255, 0, 0], type='', swap='kpt-205'),
        # 添加205-206点 (右眼眼球轮廓)
        205: dict(name='kpt-205', id=205, color=[255, 0, 0], type='', swap='kpt-204'),
        206: dict(name='kpt-206', id=206, color=[255, 0, 0], type='', swap='kpt-203'),
    },
    skeleton_info={},
    joint_weights=[1.] * 207,  # 更新为207个点
    sigmas=[])