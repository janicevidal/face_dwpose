...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/prealign_96x96_repghost_lite_single_ema_mle_single_norm/epoch_420.pth'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='train_1118/annotations/train_all_annotations.json',
        data_prefix=dict(img='train_1118/'),
