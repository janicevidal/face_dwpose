...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/BodyContour/rtmw-l_b128-300e_body-288x384_multi/best_AUC_epoch_299.pth'  # noqa
        )),
    neck=dict(
        type='CSPNeXtPAFPN',
...
work_dir='/home/zhangxiaoshuai/Checkpoint/BodyContour/rtmw-l_b128-300e_body-288x384_multi_finetune'
