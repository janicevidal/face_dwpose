...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Pretrained/rtmw-x_simcc-cocktail14_pt-ucoco_270e-384x288-f840f204_20231122.pth'  # noqa
        )),
    neck=dict(
        type='CSPNeXtPAFPN',
...
work_dir='/home/zhangxiaoshuai/Checkpoint/BodyContour/rtmw-x_b128-300e_body-288x384_multi'
