...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark181/kpts181_prealign_128x128_finetune235/best_NME_epoch_400.pth'
        )
        ),
    head=dict(
        type='LiteCCIntegralHead',
        in_channels=192,
        ...
        loss_cfg=[dict(methods=[dict(type='KLDiscretLoss',
