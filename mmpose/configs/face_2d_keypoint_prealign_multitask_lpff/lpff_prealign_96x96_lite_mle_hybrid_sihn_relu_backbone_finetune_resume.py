...
mean_face='/data/xiaoshuai/facial_lanmark/train_1226/mean_face_20_d/mean_landmarks.npy'
...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_prealign_96x96_lite_mle_hybrid_sihn_relu_backbone_finetune/best_NME_epoch_382.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_prealign_96x96_lite_mle_hybrid_sihn_relu/best_NME_epoch_394.pth'
        )
        ),
    head=dict(
...
# val_pipeline = [
#     dict(type='LoadImage', backend_args=backend_args),
#     dict(type='TopdownAlignV3', 
#          input_size=codec['input_size'], 
#          mean_face_path='/data/xiaoshuai/facial_lanmark/train_1226/mean_face_20_d/mean_face_symmetric_centered.npy',
#          point_set_types=['val'],
#          jitter_prob=0.0,
#          interpolation_method='linear',
#          ),
...
train_pipeline = [
    ...
    dict(type='TopdownAlignV2', 
         input_size=codec['input_size'], 
         mean_face_path=mean_face,
         point_set_types = ['four', 'five', 'nineteen', 'twenty_three', 'base'],
         point_set_weights = [0.25, 0.05, 0.3, 0.4, 0.1],
         margin_ratio = 0.016,
         scale_range=(0.9, 1.05),
         rotation_range=(-8, 8),
         translation_ratio_range=(-0.0625, 0.0625),
         jitter_prob=1.0
         ),
