...
param_scheduler = [
    ...
    dict(
        ...
        periods=[205, 210],  # 每个周期的epoch数
        restart_weights=[1, 1],  # 每次重启时学习率重置的权重
        eta_min=0.00002,
        begin=5,
        end=420,
        by_epoch=True,
...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_prealign_96x96_lite_mle_hybrid_sihn_relu_bf_v4_resume_twice/best_NME_epoch_381.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_prealign_96x96_lite_mle_hybrid_sihn_relu_backbone_finetune_resume/best_NME_epoch_403.pth'
        )
        ),
    head=dict(
...
data_mode = 'topdown'
data_root = '/data/xiaoshuai/facial_lanmark/train_1226/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/train_angles_annotations.json',
