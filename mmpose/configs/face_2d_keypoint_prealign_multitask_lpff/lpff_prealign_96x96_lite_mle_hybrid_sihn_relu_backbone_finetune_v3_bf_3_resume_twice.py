...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_prealign_96x96_lite_mle_hybrid_sihn_relu_backbone_finetune_v3_bf_3_resume/epoch_420.pth'
...
train_pipeline = [
    ...
    dict(type='TopdownAlignV3', 
         ...
         point_set_weights = [0.2, 0.05, 0.15, 0.3, 0.3],
         margin_ratio = 0.016,
         scale_range=(0.9, 1.1),
