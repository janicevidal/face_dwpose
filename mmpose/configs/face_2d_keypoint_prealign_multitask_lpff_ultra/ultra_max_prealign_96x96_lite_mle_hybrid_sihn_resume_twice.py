...
mean_face='/data/xiaoshuai/facial_lanmark/train_1226/mean_face_20_d/mean_face_symmetric_centered.npy'

load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/ultra_max_prealign_96x96_lite_mle_hybrid_sihn_resume/best_NME_epoch_340.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark/ultra_prealign_96x96_lite_mle_hybrid_sihn_resume/epoch_420.pth'
        )
        ),
    head=dict(
...
train_pipeline = [
    ...
    dict(type='TopdownAlignV4', 
         input_size=codec['input_size'], 
         mean_face_path=mean_face,
         point_set_types = ['four', 'nineteen', 'twenty_three', 'base'],
         point_set_weights = [0.2, 0.1, 0.4, 0.3],
         margin_ratio = 0.016,
         scale_range=(0.9, 1.1),
         rotation_range=(-10, 10),
         translation_params=(0, 3.6),
         jitter_prob=0.875
         ),
    dict(type='EyeConstrainedCoarseDropout', 
         ...
         max_size=0.3,
         random_color=False,
         left_eye_indices=list(range(77, 101)),
         right_eye_indices=list(range(101, 125)),
...
dataset_base = dict(
    ...
    data_root=data_root,
    data_mode=data_mode,
    ann_file='annotations/train_angles_annotations_slim.json',
    data_prefix=dict(img='images/'),
)

dataset_ultra = dict(
    type=dataset_type,
    data_root='/data/xiaoshuai/facial_lanmark/train_0325_0417/',
    data_mode=data_mode,
    ann_file='annotations/train_angles_annotations_0417.json',
    data_prefix=dict(img='images/'),
)

dataset_ultra_max = dict(
    type=dataset_type,
    data_root='/data/xiaoshuai/facial_lanmark/train_0418_0430/',
    data_mode=data_mode,
    ann_file='annotations/train_angles_annotations_0430.json',
    data_prefix=dict(img='images/'),
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(from_file='configs/_base_/datasets/inshot.py'),
        datasets=[dataset_base, dataset_ultra, dataset_ultra_max],
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/val_angles_annotations.json',
