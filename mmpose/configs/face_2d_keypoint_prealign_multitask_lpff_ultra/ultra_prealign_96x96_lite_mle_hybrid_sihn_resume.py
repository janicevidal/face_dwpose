...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/ultra_prealign_96x96_lite_mle_hybrid_sihn/epoch_420.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_pro_prealign_96x96_lite_mle_hybrid_sihn_resume_twice/best_NME_epoch_389.pth'
        )
        ),
    head=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[dataset_base, dataset_ultra],
