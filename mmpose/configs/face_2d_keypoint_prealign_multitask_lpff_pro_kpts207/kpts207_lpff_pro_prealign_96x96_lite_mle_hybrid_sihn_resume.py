...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/kpts207_lpff_pro_prealign_96x96_lite_mle_hybrid_sihn/epoch_420.pth'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/train_angles_annotations_207.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/val_angles_annotations_207.json',
