...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_pro_prealign_96x96_lite_mle_hybrid_sihn/best_NME_epoch_407.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark/lpff_pro_prealign_96x96_lite_mle_hybrid_sihn/best_NME_epoch_407.pth'
        )
        ),
    head=dict(
