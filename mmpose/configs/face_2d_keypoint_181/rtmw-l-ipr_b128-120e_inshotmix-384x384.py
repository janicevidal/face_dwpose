...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark181/rtmw-l_b128-120e_inshotmix-384x384_finetune_body_pretrain_neck_refine_box1_2/epoch_120.pth'  # noqa
        )),
    neck=dict(
        type='CSPNeXtPAFPN',
    ...
    head=dict(
        ...
        gau_cfg=dict(
            ...
            use_rel_bias=False,
            pos_enc=False),
        loss_cfg=[dict(methods=[dict(type='MaskKLDiscretLoss',
...
work_dir='/home/zhangxiaoshuai/Checkpoint/FacialLandmark181/rtmw-l-ipr_b128-120e_inshotmix-384x384'
