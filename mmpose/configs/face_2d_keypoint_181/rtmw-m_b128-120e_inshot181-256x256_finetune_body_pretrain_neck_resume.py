...
load_from = '/home/zhangxiaoshuai/Checkpoint/FacialLandmark181/rtmw-m_b128-120e_inshot181-256x256_finetune_body_pretrain_neck/epoch_120.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Pretrained/rtmw-dw-l-m_simcc-cocktail14_270e-256x192-20231122.pth'  # noqa
        )),
    neck=dict(
        type='CSPNeXtPAFPN',
