...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Checkpoint/FacialLandmark/prealign_96x96_repghost_lite_single_ema_scalenorm/best_NME_epoch_412_.pth'
        )
        ),
    head=dict(
        type='LiteImplicitHead',
        in_channels=96,
        ...
        loss_cfg=[dict(methods=[dict(type='KLDiscretLoss',
                    ...
                    dict(methods=[dict(type='IHLLoss',
                                       use_target_weight=False,
                                       size_average=True, 
                                       residual=True
                                       )
