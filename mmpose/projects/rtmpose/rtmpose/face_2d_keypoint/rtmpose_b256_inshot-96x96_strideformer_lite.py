    ...
    data_preprocessor=dict(
     ...
     backbone=dict(
        ...
        mobileV3_cfg=[
            ...
            [[5, 48, 32, False, 'HSwish', 2], [5, 96, 32, False, 'HSwish', 1]],  # cfg2
            [[5, 128, 64, False, 'HSwish', 2], [5, 160, 64, False, 'HSwish', 1]],  # cfg3
            [[3, 384, 96, False, 'HSwish', 2], [3, 384, 96, False, 'HSwish', 1]],  # cfg4
        ],
