...
model = dict(
    ...
    data_preprocessor=dict(
     ...
     backbone=dict(
        ...
        mobileV3_cfg=[
            # k t c, s
            [[3, 16, 16, True, 'ReLU', 1], [3, 64, 32, False, 'ReLU', 2], [3, 96, 32, False, 'ReLU', 1]],  # cfg1
            [[5, 128, 64, True, 'HSwish', 2], [5, 240, 64, True, 'HSwish', 1]],  # cfg2
            [[5, 384, 128, True, 'HSwish', 2], [5, 384, 128, True, 'HSwish', 1]],  # cfg3
            [[5, 768, 192, True, 'HSwish', 2], [5, 768, 192, True, 'HSwish', 1]],  # cfg4
        ],
        ...
        init_cfg=dict(
            type='Pretrained',
            # prefix='backbone.',
            checkpoint='/home/zhangxiaoshuai/Pretrained/pp_mobileseg_mobilenetv3_3rdparty-base-ed0be681.pth'
        )),
    head=dict(
        type='LiteCCHead',
        in_channels=256,
