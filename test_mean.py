...
path = '/data/xiaoshuai/facial_landmark_181/mean_face/mean_face_symmetric_centered_181.npy'
mean_face = np.load(path)
...
points1 = mean_face[idx].astype(np.float32) * 128.0
...
mean_face_128_5 = mean_face[[120, 125, 143, 153]].astype(np.float32) * 128.0

x_coords = mean_face_128_5[:, 0]  # 所有x坐标
y_coords = mean_face_128_5[:, 1]  # 所有y坐标
