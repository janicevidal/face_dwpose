...
from ssfd_mnn_infer import *
from landmark_mnn_infer import *
...
def ssfd(camera):
    detector = SSFD(
        model_file=
        '/Users/user/Project/FacialLandmark/demo_web/mnn/scrfd_lite_320_kpts_tood_resume_tal_anchor_mod_shape192x320.mnn')
    
    landmarker = DWPOSE(
        model_file=
        '/Users/user/Project/FacialLandmark/demo_web/mnn/end2end_slim.mnn')
    ...
    while True:
        ...
        bboxes, _ = detector.detect(frame, 0.72, input_size = (320, 192))
        ...
        for i in range(new_boxes.shape[0]):
            ...
            kpss,_ = landmarker.infer(frame, (x1, y1, x2, y2))
